...
class Game {
    ...
    update () {
        ...
        document.getElementById("scoreli").innerHTML = "<strong>Score:</strong> " + this.score;
        document.getElementById("livesli").innerHTML = "<strong>Lives:</strong> " + this.player.lives;
    }
